...
function ScenarioClick()
    if scenarioBackActive then
        ...
        UI.setAttribute("scenario_Carousel", "image", scenarioTable[chosenScenarioIndex] .. "_Front")
    else
        scenarioBackActive = true
        UI.setAttribute("scenario_Carousel", "image", scenarioTable[chosenScenarioIndex] .. "_Back")
    end
end
...
function ButtonScenarioLeftClick()
    chosenScenarioIndex = chosenScenarioIndex - 1
...
function ButtonStartGameClick()
    log("Starting the game with Scenario " .. chosenScenarioIndex .. "!")
    SetupGame(achievements, chosenScenarioIndex)
end